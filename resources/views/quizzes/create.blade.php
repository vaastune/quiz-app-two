    ...
    <form action="{{ route('quizzes.store') }}" method="POST">
        ...
        <div id="questions-container">
            <div class="question-group">
                ...
                <div class="form-group">
                    <label>Choices for Question 1 (Select the correct answer):</label>
                ...
                <div class="form-group">
                    <label for="correct-1">Select the correct choice (1-4):</label>
                    <input type="number" class="form-control" name="correct[0]" min="1" max="4" required>
                </div>
            </div>

            <!-- Repeat for more questions as needed -->
        </div>
